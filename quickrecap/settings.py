"""
Django settings for quickrecap project.
...
SECRET_KEY = 'django-insecure-le&)-otbo2l2!8xj%_pklg0&2ew_v3(b6b@6qjv8_0b#vm3l1x'
...
WSGI_APPLICATION = 'quickrecap.wsgi.application'
